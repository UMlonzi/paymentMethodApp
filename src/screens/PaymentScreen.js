...
// import logo from './assets/al 2.jpg'; 
const PaymentScreen = () => {
    ...
    const onCheckStatus = async (paymentResponse) => {
        ...
        try {
            ...
            const stripeResponse = await axios.post('http://localhost:9000/payment', {
                email: 'usimancobo@gmail.com',
                product: cartInfo,
